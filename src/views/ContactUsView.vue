<template>
  ...
  <section class="ls s-py-xl-160 s-py-lg-130 s-py-md-90 s-py-60 c-mb-30 ">
    <div class="container">
      <div class="row">
              ...
              <div class="row c-mb-10 c-gutter-10">
                <div class="col-sm-12">
                  <div class="form-group has-placeholder">
                    ...
                    <textarea aria-required="true" rows="3" cols="45" name="message" id="message335553" class="form-control" placeholder="Your Message"></textarea>
                  </div>
                </div>
              </div>
              <div class="row c-mb-10 c-gutter-10">
